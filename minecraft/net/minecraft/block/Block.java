...
public class Block
{
    ...
    public int getBlockBrightness(IBlockAccess p_149677_1_, int p_149677_2_, int p_149677_3_, int p_149677_4_)
    {
    	...
    	//if (!Wolfpack.getModuleManager().findMod(FullBright.class).isEnabled()) {
    ...
    public boolean shouldSideBeRendered(IBlockAccess p_149646_1_, int p_149646_2_, int p_149646_3_, int p_149646_4_, int p_149646_5_)
    {
    	if (Wolfpack.getModuleManager().findMod(XRay.class).isEnabled()) {
    		for (String blockName: XRay.getXRayList()){
    			if (p_149646_1_.getBlock(p_149646_2_, p_149646_3_, p_149646_4_) == Block.getBlockFromName(blockName)) {
    				return true;
    			}
    		}
    		return false;
